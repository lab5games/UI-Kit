...
Shader "Lab5Games/UI/Outline"
{
    Properties
    {
        ...
        _LineAlpha("Line Alpha", Range(0, 1.0)) = 1.0
        ...
        SubShader
        {
            ...
            CGPROGRAM
                ...
                fixed4 frag(v2f IN) : SV_Target
                {
                    ...
                    half2 destUv = half2(_LineWidth * _MainTex_TexelSize.x * 200, _LineWidth * _MainTex_TexelSize.y * 200);
                    ...
                    result *= (1 - color.a) * _LineAlpha;
                    half4 outline = _LineColor;
                    outline.a = result;
